...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Schedule | ODMS Enterprises</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title"><i class="ti ti-layout-tab-v"></i> Schedule Records</h6>
                                  <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">List of Work Shedule <i class="mdi mdi-arrow-down"></i></a></li>
                                    ...
                                    <div class="float-end d-none d-md-block">
                                        <div class="text-center">
                                                ...
                                                <?php if($role == '1') { ?>
                                                    ...
                                                    <?php include 'scheduleAddModal.php'; ?>
                                                <?php } ?>
                                         </div>
                  ...
                  ?>
                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                $page = 'schedule';
                                                $i = 1;
                                                $schedule = mysqli_query($conn,"select * from tbl_schedule") or die (mysqli_error($conn));
                                                ...
                                                <tr>
                                                    <td><?php echo $i++; ?></td>
                                                    <td><?php echo date("H:i A",strtotime($rowSchedule['time_in_morning'])) ?></td>
                                                    <td><?php echo date("H:i A",strtotime($rowSchedule['time_out_morning'])) ?></td>
                                                    <td><?php echo ($rowSchedule['Sched']) ?></td>
                                                    <td>
                                                        <div class="btn-group">
