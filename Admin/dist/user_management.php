...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>User Management | E-Learning System for CCSIC</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">User Management Record</h6>
                                  <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">List of users <i class="mdi mdi-arrow-down"></i></a></li>
