...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Student Log | E-Learning Material for CCSICT</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Student's Log Record</h6>
                                 <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="#">List of student's log <i class="mdi mdi-arrow-down"></i></a></li>
                                </ol>
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="text-center">
                                                    <!-- Satic modal -->
                                                    <a href="student_log_print.php" type="button" class="btn btn-primary waves-effect waves-light">
                 ...
                 <?php 
                          $page = 'log';
                           $i = 1;
                            ...
                            <td>
                            <?php if($rowLog['status']=='Log in') { ?>
                             <span class="badge bg-success"><?php echo $rowLog['status']?></span>
                            <?php }else { ?>
                             <span class="badge bg-danger"><?php echo $rowLog['status']?></span>
                            <?php } ?>  
                            </td>
                            <td>
                  <div class="btn-group">
                      <button type="button" class="btn btn-danger btn-sm waves-effect waves-light"  data-bs-toggle="modal" data-bs-target="#delete<?php echo $id ?>">
