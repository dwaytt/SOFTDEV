...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Position | ODMS Enterprises</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title"><i class="ti ti-layout-tab-v"></i> Position Records</h6>
                                  <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">List of Work Position <i class="mdi mdi-arrow-down"></i></a></li>
                                    ...
                                    <div class="float-end d-none d-md-block">
                                        <div class="text-center">
                                                ...
                                                <?php if($role == '1') { ?>
                                                    ...
                                                    <?php include 'positionAddModal.php'; ?>
                                                <?php } ?>
                                         </div>
                  ...
                  ?>
                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                $page = 'position';
                                                $i = 1;
                                                $position = mysqli_query($conn,"select * from tbl_work_position") or die (mysqli_error($conn));
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo number_format($rowPosition['rate'],2) ?> PHP</td>
                                                    <td>
                                                        <div class="btn-group">
