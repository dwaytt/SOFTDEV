                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                  ...
                                  <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="#">Leave Message <i class="mdi mdi-arrow-down"></i></a></li>
                  ...
                  ?>
                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                $i = 1;
                                                $id = $_GET['id'];
                                                $leave = mysqli_query($conn,"select * from tbl_leave where id ='$id'
                                                    ") or die (mysqli_error($conn));
                                                while($leaveRow = mysqli_fetch_assoc($leave)) {
                                                $id = $leaveRow['id'];
                                                 ?>
  
                                                <label><?php echo $leaveRow['leave_message'] ?></label>
                                        ...
                                        <div class="btn-group">
                                             <a href="leave.php"class="btn btn-warning btn-sm waves-effect waves-light">
